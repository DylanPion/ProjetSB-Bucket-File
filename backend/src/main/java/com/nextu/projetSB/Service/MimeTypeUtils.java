...
// Fait partie du module "spring-core" est utilisée pour manipuler les types de médias (mimes) dans une appplication.
// Elle fournit des méthodes utilitaires pour travailler avec les types MIME.
